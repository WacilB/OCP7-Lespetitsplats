...
function deleteFilter(type, name){
  switch (type){
    case "ingredients":
      ...
      let IngredientRecipeDisplay = document.querySelectorAll(".recipe__card:not(.recette-cacher)")
    ...
    case "appliance":
      ...
      applianceToDisplay = [];
      let ApplianceRecipeDisplay = document.querySelectorAll(".recipe__card:not(.recette-cacher)")
    ...
    case "ustensils":
      ...
      ustensilsToDisplay = [];
      let UstensilsRecipeDisplay = document.querySelectorAll(".recipe__card:not(.recette-cacher)")
